...
func (c *billingServiceClient) GetPayment(ctx context.Context, in *GetPaymentRequest, opts ...grpc.CallOption) (*Payment, error) {
...
func (UnimplementedBillingServiceServer) GetPayment(context.Context, *GetPaymentRequest) (*Payment, error) {
...
var BillingService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto_contracts/billing.proto",
}
